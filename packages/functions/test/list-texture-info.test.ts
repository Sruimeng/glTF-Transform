...
import { listTextureInfo, listTextureInfoByMaterial } from '@sruimeng/gltf-functions';
import { KHRMaterialsSheen, KHRMaterialsVolume } from '@sruimeng/gltf-extensions';
