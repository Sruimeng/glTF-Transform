...
import { Accessor, Document, GLTF, Primitive, Transform, TransformContext } from '@sruimeng/gltf-core';
import { getGLPrimitiveCount, createTransform, isTransformPending, assignDefaults } from '@sruimeng/gltf-functions';
