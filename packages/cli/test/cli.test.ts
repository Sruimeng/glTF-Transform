...
import tmp from 'tmp';
import { Document, FileUtils, NodeIO } from '@sruimeng/gltf-core';
import { ALL_EXTENSIONS } from '@sruimeng/gltf-extensions';
import { program, programReady } from '@sruimeng/gltf-cli';
